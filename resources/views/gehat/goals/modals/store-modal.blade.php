    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">أضافه هدف جديده</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form action="{{route('dashboard.goals.store')}}" id="store-new-category">
                    @csrf
                    <div class="mb-2">
                        <label for="goal" class="col-form-label">أسم الهدف</label>
                        <input type="text" name="goal" placeholder="أسم الهدف" class="form-control" id="name" required>
