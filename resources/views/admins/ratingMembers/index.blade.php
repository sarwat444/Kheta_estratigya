            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="d-flex flex-wrap gap-2 mb-3">
                        <a href="{{route('dashboard.ratingMembers.create')}}" class="btn btn-primary waves-effect waves-light">
...
@push('scripts')
    ...
    @include('admins.users.ratingMembers.scripts.delete')
@endpush
