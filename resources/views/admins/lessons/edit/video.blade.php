...
@push('title',__('admin-dashboard.edit video lesson'))
...
@section('content')
    <div class="row">
        <div class="col-xl-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title mb-4">{{__('admin-dashboard.edit video lesson')}}</h4>
                    <form id="update-lesson-video" action="{{route('dashboard.lessons.update.video',$lesson->id)}}"
                          method="POST">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <select name="type" class="form-control select2" required>
                                        ...
                                        <option
                                            value="{{\App\Enums\LessonType::video->value}}"
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <select name="provider" class="form-control select2" required>
                                        ...
                                        <option
                                            value="{{\App\Enums\LessonProvider::vimeo->value}}"
...
@push('scripts')
    ...
    @include('admins.lessons.scripts.edit-video')
@endpush
