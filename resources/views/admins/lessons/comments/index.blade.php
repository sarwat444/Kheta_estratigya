...
@section('content')
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title mb-3">Lesson Comments:</h4>
                    <table id="lesson-comments-datatable"
...
@push('scripts')
    ...
    @include('admins.lessons.comments.scripts.datatable')
@endpush
