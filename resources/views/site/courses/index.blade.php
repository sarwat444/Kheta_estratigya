...
@push('title','all courses')


@section('content')

    @include('site.courses.partials.slider')

    <!-- Courses Start -->
    <div class="courses-section section-padding-01">
        <div class="container">
            @include('site.courses.partials.filter')
                    ...
                    <div class="row gy-6">
                        @forelse($courses as $course)
                            <div class="col-xl-3 col-lg-4 col-sm-6">
                                <!-- Course Start -->
                                <div class="course-item-02" data-course-id="{{$course->id}}" data-aos="fade-up"
                                     data-aos-duration="1000">
                                    <div class="course-header">
                                        <div class="course-header__thumbnail rounded-0">
                                            <a href="{{route('site.courses.show',$course->id)}}"><img
                                    ...
                                    <div class="course-info-02">
                                        <span
                                            class="course-info-02__badge-text {{\App\Enums\CourseLevel::badgeBootstrap(\App\Enums\CourseLevel::tryFrom($course->level))}}">{{\App\Enums\CourseLevel::tryFrom($course->level)->name}}</span>
                                ...
                                <div class="course-list-info__footer">
                                    ...
                                    <div class="course-list-info__rating">
                                        ...
                                        <div class="rating-average">
                                            <span
                                                class="rating-average__average">{{round($course->rates_avg_rate,2)}}</span>
