<form id="upload-video-course" action="{{$uploadLink}}" method="POST" enctype="multipart/form-data">
    ...
    <div class="row gy-6">
        <div class="col-12">
            ...
            <div class="dashboard-content-box">
                <h4 class="dashboard-content-box__title">Upload Course Video Information</h4>
                <div class="row gy-4">
                    <div class="col-md-12">
                        <div class="mb-3">
                            <label for="file_data" class="form-label">Course Video</label>
    ...
    <div class="dashboard-settings__btn">
        <button type="submit" id="submit-form-upload" class="btn btn-primary btn-hover-secondary">Upload</button>
    </div>
</form>
