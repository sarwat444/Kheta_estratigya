...
class DashboardController extends Controller
{
    ...
    public function kheta_dashboard($kheta_id , $year_id = null): \Illuminate\View\View
    {
        ...
        }else
        {
            ...
            return view('admins.dashboard.objectives', compact('Execution_years', 'objectives' ,'kheta_id'));
        }
    }
    ...
    public function mokashrat_statastics($kheta_id ,$program_id ,  $year_id = null )
    {
